...
/*
        initFriends();
        FriendsAdapter adapter = new FriendsAdapter(MainActivity.this, R.layout.frienddetails, friendsList);
        ListView listView = (ListView) findViewById(R.id.friend_list_view);
        listView.setAdapter(adapter);
*/

        Friends=(Button) findViewById(R.id.enterfriends);
...
/*
    private void initFriends(){
        Friends deng = new Friends("邓栩",R.drawable.friend,R.id.delete);
        friendsList.add(deng);
        Friends liu = new Friends("刘远琴",R.drawable.friend,R.id.delete);
        friendsList.add(liu);
        Friends chen = new Friends("陈恬",R.drawable.friend,R.id.delete);
        friendsList.add(chen);
        Friends hu = new Friends("胡珊",R.drawable.friend,R.id.delete);
        friendsList.add(hu);
    }
*/
    /**
